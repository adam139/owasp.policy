...
from dexterity.membrane.content.member import IConferenceMember
...
from owasp.policy.browser.interfaces import IThemeSpecific
...
"""
class IRegistrationForm(IConferenceMember):
